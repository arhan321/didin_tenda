...
-- ----------------------------
INSERT INTO `category_products` VALUES (1, 'FOTOCOPY', NULL, '2024-10-31 09:58:41', NULL);
...
CREATE TABLE `delivery_orders`  (
  ...
  `product` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `status` enum('pending','delivered','canceled') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `pengantar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `tanggal_pengiriman` date NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `delivery_orders_client_id_foreign`(`client_id`) USING BTREE,
  INDEX `delivery_orders_alamat_id_foreign`(`alamat_id`) USING BTREE,
  INDEX `delivery_orders_cabang_id_foreign`(`cabang_id`) USING BTREE,
  CONSTRAINT `delivery_orders_alamat_id_foreign` FOREIGN KEY (`alamat_id`) REFERENCES `clients` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `delivery_orders_cabang_id_foreign` FOREIGN KEY (`cabang_id`) REFERENCES `clients` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `delivery_orders_client_id_foreign` FOREIGN KEY (`client_id`) REFERENCES `clients` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 50 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of delivery_orders
-- ----------------------------
INSERT INTO `delivery_orders` VALUES (41, 4, 4, 4, '[{\"id\":1,\"qty\":\"1\",\"price\":\"900000.00\"}]', 'delivered', 'ALIEF', '2024-07-15', '2024-10-31 14:12:41', '2024-10-31 14:12:41', NULL);
INSERT INTO `delivery_orders` VALUES (42, 5, 5, 5, '[{\"id\":1,\"qty\":\"1\",\"price\":\"900000.00\"}]', 'delivered', 'ALIEF', '2024-07-15', '2024-10-31 14:13:11', '2024-10-31 14:13:11', NULL);
INSERT INTO `delivery_orders` VALUES (43, 2, 2, 2, '[{\"id\":1,\"qty\":\"1\",\"price\":\"900000.00\"}]', 'delivered', 'ALIEF', '2024-07-16', '2024-10-31 14:13:45', '2024-10-31 14:13:45', NULL);
INSERT INTO `delivery_orders` VALUES (44, 3, 3, 3, '[{\"id\":1,\"qty\":\"1\",\"price\":\"900000.00\"}]', 'delivered', 'ALIEF', '2024-07-16', '2024-10-31 14:15:04', '2024-10-31 14:15:04', NULL);
INSERT INTO `delivery_orders` VALUES (45, 6, 6, 6, '[{\"id\":1,\"qty\":\"1\",\"price\":\"900000.00\"}]', 'delivered', 'ALIEF', '2024-07-17', '2024-10-31 14:17:03', '2024-10-31 14:17:03', NULL);
INSERT INTO `delivery_orders` VALUES (46, 1, 1, 1, '[{\"id\":1,\"qty\":\"1\",\"price\":\"900000.00\"}]', 'delivered', 'ALIEF', '2024-07-18', '2024-10-31 14:17:32', '2024-10-31 14:17:32', NULL);
INSERT INTO `delivery_orders` VALUES (47, 7, 7, 7, '[{\"id\":3,\"qty\":\"1\",\"price\":\"650000.00\"}]', 'delivered', 'ALIEF', '2024-08-05', '2024-10-31 14:52:22', '2024-10-31 14:52:22', NULL);
INSERT INTO `delivery_orders` VALUES (48, 6, 6, 6, '[{\"id\":3,\"qty\":\"1\",\"price\":\"650000.00\"}]', 'delivered', 'ALIEF', '2024-08-06', '2024-10-31 14:53:59', '2024-10-31 14:54:17', NULL);
INSERT INTO `delivery_orders` VALUES (49, 7, 7, 7, '[{\"id\":3,\"qty\":\"2\",\"price\":\"650000.00\"}]', 'delivered', 'ALIEF', '2024-08-14', '2024-10-31 14:54:56', '2024-10-31 14:54:56', NULL);
...
-- Records of invoices
-- ----------------------------
INSERT INTO `invoices` VALUES (10, 6, 6, 6, '[{\"id\":8,\"qty\":\"1\",\"price\":\"320000.00\"},{\"id\":12,\"qty\":\"1\",\"price\":\"150000.00\"},{\"id\":14,\"qty\":\"1\",\"price\":\"30000.00\"}]', 500000, 'CASH', 'Sudah bayar', NULL, '2024-10-23', '2024-10-23', '2024-10-24 09:18:33', '2024-10-25 17:36:39', NULL);
...
INSERT INTO `invoices` VALUES (24, 7, 7, 7, '[{\"id\":16,\"qty\":\"1\",\"price\":\"435000.00\"},{\"id\":17,\"qty\":\"1\",\"price\":\"1492500.00\"}]', 1927500, NULL, 'Belum bayar', NULL, '2024-10-25', '2024-10-25', '2024-10-25 10:09:26', '2024-10-25 10:09:26', NULL);
INSERT INTO `invoices` VALUES (25, 4, 4, 4, '[{\"id\":22,\"qty\":\"7\",\"price\":\"72500.00\"}]', 507500, 'CASH', 'Belum bayar', NULL, '2024-10-30', '2024-11-30', '2024-10-30 15:52:40', '2024-10-30 16:01:10', '2024-10-30 16:01:10');
INSERT INTO `invoices` VALUES (26, 4, 4, 4, '[{\"id\":22,\"qty\":\"6\",\"price\":\"72500.00\"}]', 435000, 'CASH', 'Sudah bayar', NULL, '2024-10-30', '2024-11-30', '2024-10-30 16:01:38', '2024-10-30 16:47:36', NULL);
...
CREATE TABLE `laptops`  (
  ...
  `type_laptop` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `sn_laptop` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `tahun_laptop` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `garansi` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `charger` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `tas` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `cabang` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `bisnis_unit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of laptops
-- ----------------------------
INSERT INTO `laptops` VALUES (1, 'arhan', 'adsfasdf', 'asdfasdf', '2017', 'asdfads', 'fasdfadsf', 'asdfadsf', 'asdfads', 'adsfasdf', '2024-10-26 13:05:33', '2024-10-26 13:11:56', '2024-10-26 13:11:56');
...
INSERT INTO `migrations` VALUES (20, '2024_10_26_121100_create_laptops_table', 3);
INSERT INTO `migrations` VALUES (21, '2024_10_28_010450_create_delivery_orders_table', 4);
INSERT INTO `migrations` VALUES (22, '2024_10_30_032230_create_monitoring_laptops_table', 5);

-- ----------------------------
-- Table structure for monitoring_laptops
-- ----------------------------
DROP TABLE IF EXISTS `monitoring_laptops`;
CREATE TABLE `monitoring_laptops`  (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `client_id` bigint UNSIGNED NULL DEFAULT NULL,
  `alamat_id` bigint UNSIGNED NULL DEFAULT NULL,
  `cabang_id` bigint UNSIGNED NULL DEFAULT NULL,
  `product` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `tanggal_pengiriman` date NULL DEFAULT NULL,
  `jumlah_barang` bigint NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `monitoring_laptops_client_id_foreign`(`client_id`) USING BTREE,
  INDEX `monitoring_laptops_alamat_id_foreign`(`alamat_id`) USING BTREE,
  INDEX `monitoring_laptops_cabang_id_foreign`(`cabang_id`) USING BTREE,
  CONSTRAINT `monitoring_laptops_alamat_id_foreign` FOREIGN KEY (`alamat_id`) REFERENCES `clients` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `monitoring_laptops_cabang_id_foreign` FOREIGN KEY (`cabang_id`) REFERENCES `clients` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `monitoring_laptops_client_id_foreign` FOREIGN KEY (`client_id`) REFERENCES `clients` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 36 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of monitoring_laptops
-- ----------------------------
INSERT INTO `monitoring_laptops` VALUES (27, 4, NULL, NULL, '[{\"id\":1,\"qty\":\"1\",\"price\":\"900000.00\"}]', '2024-07-15', 1, '2024-10-31 14:12:42', '2024-10-31 14:12:42', NULL);
INSERT INTO `monitoring_laptops` VALUES (28, 5, NULL, NULL, '[{\"id\":1,\"qty\":\"1\",\"price\":\"900000.00\"}]', '2024-07-15', 1, '2024-10-31 14:13:11', '2024-10-31 14:13:11', NULL);
INSERT INTO `monitoring_laptops` VALUES (29, 2, NULL, NULL, '[{\"id\":1,\"qty\":\"1\",\"price\":\"900000.00\"}]', '2024-07-16', 1, '2024-10-31 14:13:45', '2024-10-31 14:13:45', NULL);
INSERT INTO `monitoring_laptops` VALUES (30, 3, NULL, NULL, '[{\"id\":1,\"qty\":\"1\",\"price\":\"900000.00\"}]', '2024-07-16', 1, '2024-10-31 14:15:05', '2024-10-31 14:15:05', NULL);
INSERT INTO `monitoring_laptops` VALUES (31, 6, NULL, NULL, '[{\"id\":1,\"qty\":\"1\",\"price\":\"900000.00\"}]', '2024-07-17', 1, '2024-10-31 14:17:04', '2024-10-31 14:17:04', NULL);
INSERT INTO `monitoring_laptops` VALUES (32, 1, NULL, NULL, '[{\"id\":1,\"qty\":\"1\",\"price\":\"900000.00\"}]', '2024-07-18', 1, '2024-10-31 14:17:32', '2024-10-31 14:17:32', NULL);
INSERT INTO `monitoring_laptops` VALUES (33, 7, NULL, NULL, '[{\"id\":3,\"qty\":\"1\",\"price\":\"650000.00\"}]', '2024-08-05', 1, '2024-10-31 14:52:22', '2024-10-31 14:52:22', NULL);
INSERT INTO `monitoring_laptops` VALUES (34, 6, NULL, NULL, '[{\"id\":3,\"qty\":\"1\",\"price\":\"650000.00\"}]', '2024-08-06', 1, '2024-10-31 14:53:59', '2024-10-31 14:53:59', NULL);
INSERT INTO `monitoring_laptops` VALUES (35, 7, NULL, NULL, '[{\"id\":3,\"qty\":\"2\",\"price\":\"650000.00\"}]', '2024-08-14', 2, '2024-10-31 14:54:56', '2024-10-31 14:54:56', NULL);
...
CREATE TABLE `monitorings`  (
  ...
  `stock_sisa` bigint NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `monitorings` VALUES (1, 1, 6, 6, 0, 1, 1, '2024-10-19 10:33:07', '2024-10-31 14:17:32', NULL);
INSERT INTO `monitorings` VALUES (2, 3, 4, 4, 0, 2, 3, '2024-10-23 12:19:38', '2024-10-31 14:54:56', NULL);
INSERT INTO `monitorings` VALUES (3, 1, 10, 10, NULL, 1, 1, '2024-10-28 01:33:20', '2024-10-28 01:47:08', '2024-10-28 01:47:08');
INSERT INTO `monitorings` VALUES (4, 4, 4, 4, NULL, 2, 2, '2024-10-31 09:40:08', '2024-10-31 09:43:42', '2024-10-31 09:43:42');
INSERT INTO `monitorings` VALUES (5, 4, 4, NULL, NULL, 2, 2, '2024-10-31 09:43:58', '2024-10-31 09:44:03', '2024-10-31 09:44:03');
INSERT INTO `monitorings` VALUES (6, 4, 4, NULL, NULL, 2, 2, '2024-10-31 09:45:05', '2024-10-31 09:47:34', '2024-10-31 09:47:34');
INSERT INTO `monitorings` VALUES (7, 4, 3, 0, 3, 2, 2, '2024-10-31 09:47:48', '2024-10-31 13:08:40', NULL);
INSERT INTO `monitorings` VALUES (8, 5, 1, 0, 0, 2, 4, '2024-10-31 14:09:34', '2024-10-31 14:09:34', NULL);
...
INSERT INTO `orders` VALUES (10, 2, 2, 2, '[{\"id\":1,\"qty\":\"1\",\"price\":\"900000.00\"}]', 900000, '2024-08-20', '2024-10-20', 'pdfs/rjAE3ke8QmAPlJ4AhjXQUvc0IMKnE3HtikMybCP9.pdf', 'Sudah bayar', NULL, 'Sudah Selesai', '2024-10-22 16:45:33', '2024-10-31 15:50:21', NULL);
INSERT INTO `orders` VALUES (11, 2, 2, 2, '[{\"id\":1,\"qty\":\"1\",\"price\":\"900000.00\"}]', 900000, '2024-09-20', '2024-10-20', 'pdfs/hGCvleTttFAASZz0aYA8eNrSddN7wezJIua8DLyc.pdf', 'Sudah bayar', NULL, 'Sudah Selesai', '2024-10-22 16:49:54', '2024-10-31 15:49:55', NULL);
...
INSERT INTO `orders` VALUES (18, 7, 7, 7, '[{\"id\":3,\"qty\":\"5\",\"price\":\"650000.00\"}]', 3250000, '2024-09-20', '2024-10-20', 'pdfs/eNABoY7GGo7GC5MepoUqF061h391Z8iSp53DDGRM.pdf', 'Sudah bayar', NULL, 'Sudah Selesai', '2024-10-23 12:20:25', '2024-10-29 13:51:10', NULL);
...
INSERT INTO `permission_role` VALUES (3, 72);
INSERT INTO `permission_role` VALUES (3, 73);
INSERT INTO `permission_role` VALUES (3, 74);
INSERT INTO `permission_role` VALUES (3, 75);
INSERT INTO `permission_role` VALUES (3, 76);
...
INSERT INTO `permissions` VALUES (72, 'laptop_access', '2024-10-26 12:16:31', '2024-10-26 12:16:31', NULL);
INSERT INTO `permissions` VALUES (73, 'laptop_create', '2024-10-26 12:39:58', '2024-10-26 12:39:58', NULL);
INSERT INTO `permissions` VALUES (74, 'laptop_edit', '2024-10-26 12:40:08', '2024-10-26 12:40:08', NULL);
INSERT INTO `permissions` VALUES (75, 'laptop_show', '2024-10-26 12:40:14', '2024-10-26 12:40:14', NULL);
INSERT INTO `permissions` VALUES (76, 'laptop_delete', '2024-10-26 12:40:20', '2024-10-26 12:40:20', NULL);
INSERT INTO `permissions` VALUES (77, 'deliveryorder_access', '2024-10-28 00:52:59', '2024-10-28 01:05:14', NULL);
INSERT INTO `permissions` VALUES (78, 'deliveryorder_create', '2024-10-28 00:53:09', '2024-10-28 01:05:19', NULL);
INSERT INTO `permissions` VALUES (79, 'deliveryorder_edit', '2024-10-28 00:53:17', '2024-10-28 01:05:23', NULL);
INSERT INTO `permissions` VALUES (80, 'deliveryorder_show', '2024-10-28 00:53:24', '2024-10-28 01:05:31', NULL);
INSERT INTO `permissions` VALUES (81, 'deliveryorder_delete', '2024-10-28 00:53:30', '2024-10-28 01:05:34', NULL);
INSERT INTO `permissions` VALUES (82, 'monitoringproduct_access', '2024-10-30 03:37:21', '2024-10-30 03:37:21', NULL);
INSERT INTO `permissions` VALUES (83, 'monitoringlaptop_access', '2024-10-30 03:37:39', '2024-10-30 03:37:39', NULL);
INSERT INTO `permissions` VALUES (84, 'monitoringlaptop_create', '2024-10-30 03:37:48', '2024-10-30 03:37:48', NULL);
INSERT INTO `permissions` VALUES (85, 'monitoringlaptop_edit', '2024-10-30 03:37:52', '2024-10-30 03:37:52', NULL);
INSERT INTO `permissions` VALUES (86, 'monitoringlaptop_show', '2024-10-30 03:37:58', '2024-10-30 03:37:58', NULL);
INSERT INTO `permissions` VALUES (87, 'monitoringlaptop_delete', '2024-10-30 03:38:07', '2024-10-30 03:38:07', NULL);
...
INSERT INTO `producteches` VALUES (8, 'Print head HP Deskjet 2336', 300000.00, 320000.00, '2', NULL, '2024-10-24 09:08:02', '2024-10-25 17:36:38', NULL);
INSERT INTO `producteches` VALUES (12, 'ASF Roller HP Deskjet 2336', 250000.00, 150000.00, '1', NULL, '2024-10-24 09:13:49', '2024-10-25 17:36:38', NULL);
INSERT INTO `producteches` VALUES (14, 'Refiil Inkjet HP 682 Black', 400000.00, 30000.00, '4', NULL, '2024-10-24 09:17:52', '2024-10-25 17:36:39', NULL);
...
INSERT INTO `producteches` VALUES (16, 'keyboard Laptop Probook 4430 G8', 50000.00, 435000.00, '4', NULL, '2024-10-24 09:22:23', '2024-10-25 10:09:24', NULL);
INSERT INTO `producteches` VALUES (17, 'Samsung SSD NVME PM9A1 512GB - MZ-VL2512HCJQ / SSD 512GB', 1283000.00, 1492500.00, '2', NULL, '2024-10-24 14:50:50', '2024-10-25 10:09:26', NULL);
...
INSERT INTO `producteches` VALUES (22, 'patch cord cat6, kabel LAN cat 6 UTP28SP3MBUY panjang 3 meter', 25000.00, 72500.00, '6', NULL, '2024-10-30 15:49:44', '2024-10-30 16:47:36', NULL);
...
INSERT INTO `products` VALUES (4, 'LAPTOP LENOVO L3 Thinkpad I3', 400000.00, 650000.00, '1 bulan', '2024-10-29 15:44:45', '2024-10-31 10:37:38', NULL);
INSERT INTO `products` VALUES (5, 'LAPTOP LENOVO E14 Core I5', 400000.00, 650000.00, '1 bulan', '2024-10-31 10:41:00', '2024-10-31 13:08:01', NULL);
...
INSERT INTO `vendors` VALUES (2, 'TEMEN KOMISARIS KOMENG', 'KALIANYAR', '2024-10-29 15:41:08', '2024-10-29 15:41:08', NULL);
INSERT INTO `vendors` VALUES (3, 'MALL MANGGA DUA JAKARTA', 'JAKARTA PUSAT', '2024-10-29 15:42:06', '2024-10-29 15:42:06', NULL);
INSERT INTO `vendors` VALUES (4, 'LAPTOP PUNYA KOMISARIS', 'JAKARTA BARAT', '2024-10-31 13:38:15', '2024-10-31 13:38:15', NULL);
