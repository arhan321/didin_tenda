    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-group">
                <div class="form-group">
                    <a class="btn btn-default" href="{{ route('admin.deliveryorders.index') }}">
                ...
                <table class="table table-bordered table-striped">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{-- {{ $deliveryorder->created_at ? $deliveryorder->created_at->format('d-m-Y') : 'Unknown' }} --}}
                                {{ \Carbon\Carbon::parse($deliveryorder->tanggal_pengiriman)->format('d / m / Y') }}
                            </td>
                        </tr>
                        <tr>
                            <th>
                        ...
                        <tr>
                            ...
                            <td>
                                {{ $deliveryorder->client->nama_client ?? 'Unknown' }}
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                {{ $deliveryorder->client->alamat_client ?? 'Unknown' }}
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                @if (isset($deliveryorder->product_details) && count($deliveryorder->product_details) > 0)
                                    @php
                                        $productDetails = [];
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @elseif($deliveryorder->status == 'pending')
