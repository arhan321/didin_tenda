...
<div class="modal fade" id="invoiceModal" tabindex="-1" role="dialog" aria-labelledby="invoiceModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content" style="background-image: url('/assets/gradient-transformed.png'); background-size: 900px; background-repeat: no-repeat; background-position: center;">
        ...
        <div class="modal-body" id="invoiceContent">
          ...
          <div style="font-family: Arial, sans-serif; font-size: 14px; padding: 20px;">
              ...
              <div class="paket-tulisan" style="margin-top: -20px;">
                <div style="display: flex; align-items: center;">
                  <div style="margin-right: 10px; margin-bottom: 19px;">
                    <img src="/assets/logo.png" alt="Logo" style="width: 35px; height: auto;">
                  </div>
                  <div>
                    <h2 style="color: #0033a0; margin: 0; font-size: 32px; margin-bottom: 65px; margin-top: 65px; font-family: 'Montserrat', sans-serif;">TRI ASTRA PERSADA</h2>
              ...
              <div style="text-align: right; margin-top: 130px;">
                ...
                <table style="width: 100%; border-collapse: collapse; margin-top: 10px;">
                  <tr>
                    ...
                    <td style="background-color: #ffffff; padding: 10px;"><strong>NO. SURAT JALAN</strong></td>
                  </tr>
                  <tr>
                    ...
                    <td style="padding: 5px; ">
                      {{ $deliveryorder->id }}-{{ \Carbon\Carbon::parse($deliveryorder->created_at)->format('m') }}-SJ-TAP-{{ \Carbon\Carbon::parse($deliveryorder->created_at)->format('Y') }}
                    </td>
                </tr>
                </table>
              </div>
            ...
            <div style="margin-top: 20px;">
              ...
              <p style="padding-left: 10px; margin-top: 5px;">
                  <strong>{{ $deliveryorder->client->nama_client ?? 'Unknown' }}</strong><br>
                  {{ $deliveryorder->client->alamat_client ?? 'Alamat tidak tersedia' }}
              </p>
          </div>
          ...
          {{-- <div class="tulisan"
              ...
              <p>SURAT JALAN PERIODE
                  @php
                      $formattedDate = \Carbon\Carbon::parse($deliveryorder->start)->format(' F Y');
            ...
            <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
              ...
              <tbody>
                  @php
                      $productDetails = isset($deliveryorder->product_details)
            ...
            <div style="margin-top: 40px; display: flex; justify-content: space-between;">
              ...
              <div style="text-align: left;">
                  ...
                  <p style="margin: 0; margin-top:35%;">__________________________</p>
                  <p style="margin: 0; margin-top:5%;">Pengirim, {{ $deliveryorder->pengantar ?? 'Unknown' }}</p>
              </div>
          </div>
            ...
            <p style="text-align: center; margin-top: 120px; font-style:initial; font:size: 180px;">
              ...
              CV TRI ASTRA PERSADA at +62 851-8351-9006 or email us at <a href="mailto:Triastrapersada@gmail.com">Triastrapersada@gmail.com</a>
            </p>
          </div>
        </div>
