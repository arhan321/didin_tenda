    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.orders.store') }}">
                ...
                <!-- Dropdown Cabang -->
                <div class="form-group">
                    <label for="cabang_id">{{ trans('cruds.order.fields.cabang') }}</label>
                ...
                <div class="form-group">
                    <label for="end">{{ trans('cruds.order.fields.end') }} (dibuat otomatis perhitungan 1
                        bulan)</label>
                    <input class="form-control {{ $errors->has('end') ? 'is-invalid' : '' }}" type="date" name="end"
                        id="end" value="{{ old('end', '') }}" readonly>
                    @if ($errors->has('end'))
                        <div class="invalid-feedback">
                            {{ $errors->first('end') }}
                        </div>
                ...
                <div class="form-group">
                    <label for="price">{{ trans('cruds.order.fields.total_price') }}</label>
