          ...
          <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <div style="text-align: right; margin-top: 130px;">
              ...
              <table style="width: 100%; border-collapse: collapse; margin-top: 10px;">
                ...
                <tr>
                  <td style="padding: 5px;">{{ \Carbon\Carbon::parse($order->start)->format('d/m/Y') }}</td>
                  ...
                  <td style="padding: 5px;">
                    ...
                    {{ str_pad($monthNumber, 3, '0', STR_PAD_LEFT) }}-{{ $monthInRoman }}-TAP-{{ str_pad($order->id, 4, '0', STR_PAD_LEFT) }}
                  </td>
          ...
          <div class="tulisan" style="text-align: center; font-weight: bold; font-size: 1rem; font-family: 'Arial', sans-serif;">
            <p>TAGIHAN PENYEWAAN PERIODE
                @php
                    ...
                    $formattedDate = \Carbon\Carbon::parse($order->start)->format(' F Y');
...
<script>
  ...
  const invoiceNumber = 
    "{{ str_pad(\Carbon\Carbon::parse($order->created_at)->format('m'), 3, '0', STR_PAD_LEFT) }}-{{ $monthsInRoman[\Carbon\Carbon::parse($order->created_at)->format('n')] }}-TAP-{{ str_pad($order->id, 4, '0', STR_PAD_LEFT) }}";
