    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.positions.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_posisi') ? 'is-invalid' : '' }}" type="text" name="nama_posisi" id="nama_posisi" value="{{ old('nama_posisi', '') }}">
            ...
            {{-- <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('deskripsi_posisi') ? 'is-invalid' : '' }}" name="deskripsi_posisi" id="deskripsi_posisi">{{ old('deskripsi_posisi') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('tugas_posisi') ? 'is-invalid' : '' }}" name="tugas_posisi" id="tugas_posisi">{!! old('tugas_posisi') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gaji_pokok') ? 'is-invalid' : '' }}" type="number" name="gaji_pokok" id="gaji_pokok" value="{{ old('gaji_pokok', '') }}" oninput="calculateTotalGaji()">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tunjangan_makan') ? 'is-invalid' : '' }}" type="number" name="tunjangan_makan" id="tunjangan_makan" value="{{ old('tunjangan_makan', '') }}" oninput="calculateTotalGaji()">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tunjangan_transport') ? 'is-invalid' : '' }}" type="number" name="tunjangan_transport" id="tunjangan_transport" value="{{ old('tunjangan_transport', '') }}" oninput="calculateTotalGaji()">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tunjangan_kesehatan') ? 'is-invalid' : '' }}" type="number" name="tunjangan_kesehatan" id="tunjangan_kesehatan" value="{{ old('tunjangan_kesehatan', '') }}" oninput="calculateTotalGaji()">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tunjangan_ketenagakerjaan') ? 'is-invalid' : '' }}" type="number" name="tunjangan_ketenagakerjaan" id="tunjangan_ketenagakerjaan" value="{{ old('tunjangan_ketenagakerjaan', '') }}" oninput="calculateTotalGaji()">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_gaji') ? 'is-invalid' : '' }}" type="number" name="total_gaji" id="total_gaji" value="{{ old('total_gaji', '') }}" readonly>
