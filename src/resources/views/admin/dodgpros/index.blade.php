...
@section('content')
    @can('deliveryorderdgpro_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.dodgpros.create') }}">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover datatable datatable-DeliveryOrder">
                    ...
                    <tbody>
                        ...
                        @foreach ($dodgpros as $deliveryOrder)
                            <tr data-entry-id="{{ $deliveryOrder->id }}">
                                ...
                                <!-- Aksi -->
                                <td>
                                    @can('deliveryorderdgpro_show')
                                        <a class="btn btn-xs btn-primary" href="{{ route('admin.dodgpros.show', $deliveryOrder->id) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan

                                    @can('deliveryorderdgpro_edit')
                                        <a class="btn btn-xs btn-info" href="{{ route('admin.dodgpros.edit', $deliveryOrder->id) }}">
                                            {{ trans('global.edit') }}
                                        </a>
                                    @endcan

                                    @can('deliveryorderdgpro_delete')
                                        <form action="{{ route('admin.dodgpros.destroy', $deliveryOrder->id) }}" method="POST" class="delete-form" style="display: inline-block;">
        ...
        $(function() {
            ...
            @can('deliveryorderdgpro_delete')
                ...
                let deleteButton = {
                    ...
                    url: "{{ route('admin.dodgpros.massDestroy') }}",
