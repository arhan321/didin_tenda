...
@section('content')
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('cruds.deliveryordertech.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route('admin.deliveryordertech.store') }}">
                @csrf
                ...
                <!-- Dropdown Cabang -->
                <div class="form-group">
                    <label for="cabang_id">{{ trans('cruds.deliveryordertech.fields.cabang') }}</label>
                ...
                <div class="form-group">
                    <label for="products">{{ trans('cruds.deliveryordertech.fields.product') }}</label>
                ...
                <div class="form-group">
                    <label for="status">{{ trans('cruds.deliveryordertech.fields.status') }}</label>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            const productPrices = @json($productPrices); // Harga dari Productech
            ...
            function updateProductQuantities() {
                ...
                selectedProducts.forEach(function(productId) {
                    ...
                    // Tampilkan input quantity tanpa mengecek stok
