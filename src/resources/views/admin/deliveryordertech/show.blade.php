...
<div class="card">
    <div class="card-header">
        {{ trans('global.show') }} {{ trans('cruds.deliveryordertech.title') }}
    </div>

    <div class="card-body">
        <div class="form-group">
            <div class="form-group">
                <a class="btn btn-default" href="{{ route('admin.deliveryordertech.index') }}">
            ...
            <table class="table table-bordered table-striped">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            {{ $deliveryordertech->client->nama_client ?? 'Unknown' }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            {{ $deliveryordertech->client->alamat_client ?? 'Unknown' }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            @if (isset($deliveryordertech->product_details) && count($deliveryordertech->product_details) > 0)
                                @php
                                    $productDetails = [];
                                    foreach ($deliveryordertech->product_details as $product) {
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.deliveryordertech.fields.status') }}
                        </th>
                        <td>
                            @if ($deliveryordertech->status == 'delivered')
                                <span class="status-completed">delivered</span>
                            @elseif($deliveryordertech->status == 'pending')
...
@include('admin.deliveryordertech.surat')
