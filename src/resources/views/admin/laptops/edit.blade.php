        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.laptops.update', [$laptop->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('nama_user') ? 'is-invalid' : '' }}" type="text" name="nama_user" id="nama_user" value="{{ old('nama_user', $laptop->nama_user) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('type_laptop') ? 'is-invalid' : '' }}" type="text" name="type_laptop" id="type_laptop" value="{{ old('type_laptop', $laptop->type_laptop) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('sn_laptop') ? 'is-invalid' : '' }}" type="text" name="sn_laptop" id="sn_laptop" value="{{ old('sn_laptop', $laptop->sn_laptop) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('tahun_laptop') ? 'is-invalid' : '' }}" type="text" name="tahun_laptop" id="tahun_laptop" value="{{ old('tahun_laptop', $laptop->tahun_laptop) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('garansi') ? 'is-invalid' : '' }}" type="text" name="garansi" id="garansi" value="{{ old('garansi', $laptop->garansi) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('charger') ? 'is-invalid' : '' }}" type="text" name="charger" id="charger" value="{{ old('charger', $laptop->charger) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('tas') ? 'is-invalid' : '' }}" type="text" name="tas" id="tas" value="{{ old('tas', $laptop->tas) }}">
                    @if ($errors->has('tas'))
                        <div class="invalid-feedback">
                            {{ $errors->first('tas') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('cabang') ? 'is-invalid' : '' }}" type="text" name="cabang" id="cabang" value="{{ old('cabang', $laptop->cabang) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('bisnis_unit') ? 'is-invalid' : '' }}" type="text" name="bisnis_unit" id="bisnis_unit" value="{{ old('bisnis_unit', $laptop->bisnis_unit) }}">
