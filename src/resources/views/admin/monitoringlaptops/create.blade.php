...
@section('content')
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('cruds.asetlocation.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route('admin.monitoringlaptops.store') }}">
                @csrf

                <div class="form-group">
                    <label for="tanggal_pengiriman">{{ trans('cruds.asetlocation.fields.tanggal') }}</label>
                ...
                <div class="form-group">
                    <label for="client_id">{{ trans('cruds.asetlocation.fields.nama_pemesan') }}</label>
                ...
                <!-- Dropdown Cabang -->
                <div class="form-group">
                    <label for="cabang_id">{{ trans('cruds.asetlocation.fields.cabang') }}</label>
                ...
                <!-- Dropdown Alamat -->
                <div class="form-group">
                <label for="alamat_id">{{ trans('cruds.asetlocation.fields.alamat') }}</label>
                ...
                <div class="form-group">
                    <label for="products">{{ trans('cruds.asetlocation.fields.product') }}</label>
                ...
                <!-- jumlah barang -->
                <div class="form-group">
                    <label for="jumlah_barang">{{ trans('cruds.asetlocation.fields.jumlah_barang') }}</label>
                    <input class="form-control {{ $errors->has('jumlah_barang') ? 'is-invalid' : '' }}" type="number"
                        name="jumlah_barang" id="jumlah_barang" value="{{ ('jumlah_barang') }}">
...
$(document).ready(function() {
    ...
    function updateProductQuantities() {
        ...
        selectedProducts.forEach(function(productId, index) {
            ...
            productQuantitiesContainer.append(`
                <div class="form-group">
                    <label for="qty_${productId}">${productLabel} {{ trans('cruds.asetlocation.fields.qty') }} (Stock: ${productStock})</label>
    ...
    updateProductQuantities();
        ...
        $(function() {
            ...
            let table = $('.datatable-asetlocation:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
