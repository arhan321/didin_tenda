            ...
            <table class="table table-bordered table-striped table-hover datatable datatable-test">
                <thead>
                    <tr>
                        ...
                        <th>{{ trans('cruds.client.fields.cabang') }}</th>
                        <th>{{ trans('cruds.client.fields.phone') }}</th>
                        <th>{{ trans('cruds.client.fields.secondary_phone') }}</th>
                        <th>{{ trans('cruds.client.fields.faximile') }}</th>
                ...
                <tbody>
                    @foreach($clients as $key => $client)
                        <tr data-entry-id="{{ $client->id }}">
                            ...
                            <td>{{ $client->branch_client ?? '' }}</td>
                            <td>{{ $client->nomor_telfon1_client ?? '' }}</td>
                            <td>{{ $client->nomor_telfon2_client ?? '' }}</td>
                            <td>{{ $client->faximile_client ?? '' }}</td>
