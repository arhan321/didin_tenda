        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.clients.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('nama_client') ? 'is-invalid' : '' }}" type="text"
                        name="nama_client" id="nama_client" value="{{ old('nama_client', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('branch_client') ? 'is-invalid' : '' }}" type="text"
                        name="branch_client" id="branch_client" value="{{ old('branch_client', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('alamat_client') ? 'is-invalid' : '' }}" type="text"
                        name="alamat_client" id="alamat_client" value="{{ old('alamat_client', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('nomor_telfon1_client') ? 'is-invalid' : '' }}"
                        type="text" name="nomor_telfon1_client" id="nomor_telfon1_client"
                        value="{{ old('nomor_telfon1_client', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('nomor_telfon2_client') ? 'is-invalid' : '' }}"
                        type="text" name="nomor_telfon2_client" id="nomor_telfon2_client"
                        value="{{ old('nomor_telfon2_client', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('faximile_client') ? 'is-invalid' : '' }}" type="text"
                        name="faximile_client" id="faximile_client" value="{{ old('faximile_client', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('email_client') ? 'is-invalid' : '' }}" type="text"
                        name="email_client" id="email_client" value="{{ old('email_client', '') }}">
