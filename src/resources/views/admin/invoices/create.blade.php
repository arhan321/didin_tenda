...
@section('content')
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('cruds.sahabatechinvoice.title_singular') }}
        </div>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.invoices.store') }}">
                ...
                <div class="form-group">
                    <label for="client_id">{{ trans('cruds.sahabatechinvoice.fields.nama_pemesan') }}</label>
                ...
                <!-- Dropdown Cabang -->
                <div class="form-group">
                    <label for="cabang_id">{{ trans('cruds.sahabatechinvoice.fields.cabang') }}</label>
                ...
                <!-- Dropdown Alamat -->
                <div class="form-group">
                    <label for="alamat_id">{{ trans('cruds.sahabatechinvoice.fields.alamat') }}</label>
                ...
                <div class="form-group">
                    <label for="products">{{ trans('cruds.sahabatechinvoice.fields.product') }}</label>
                ...
                <div class="form-group">
                    <label for="start">{{ trans('cruds.sahabatechinvoice.fields.start') }}</label>
                ...
                <div class="form-group">
                    <label for="end">{{ trans('cruds.sahabatechinvoice.fields.end') }}</label>
                ...
                <div class="form-group">
                    <label for="tax">{{ trans('cruds.sahabatechinvoice.fields.tax') }}</label>
                ...
                <div class="form-group">
                    <label for="price">{{ trans('cruds.sahabatechinvoice.fields.total_price') }}</label>
                ...
                <div class="form-group">
                    <label class="required">{{ trans('cruds.sahabatechinvoice.fields.status_bayar') }}</label>
                    ...
                    @endif
                    <span class="help-block">{{ trans('cruds.sahabatechinvoice.fields.status_bayar_helper') }}</span>
                </div>
            ...
            function updateProductQuantities() {
                ...
                selectedProducts.forEach(function(productId, index) {
                    ...
                    if (productStock === undefined) {
                        productStock =
                        'Stock tidak tersedia'; // Jika stok undefined, tampilkan pesan default
                    }

                    productQuantitiesContainer.append(`
                        <div class="form-group">
                            <label for="qty_${productId}">${productLabel} {{ trans('cruds.order.fields.qty') }} (Stock: ${productStock})</label>
