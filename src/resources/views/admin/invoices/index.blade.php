...
@section('content')
    @can('sahabatechinvoice_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.invoices.create') }}">
                    {{ trans('global.add') }} {{ trans('cruds.sahabatechinvoice.title_singular') }}
                </a>
            </div>
        </div>
    @endcan
    <div class="card">
        <div class="card-header">
            {{ trans('cruds.sahabatechinvoice.title_singular') }} {{ trans('global.list') }}
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover datatable datatable-invoice">
                    <thead>
                        <tr>
                            <th width="10"></th>
                            <th>{{ trans('cruds.sahabatechinvoice.fields.id') }}</th>
                            <th>Kode Invoice</th>
                            <th>{{ trans('cruds.sahabatechinvoice.fields.nama_pemesan') }}</th>
                            <th>{{ trans('cruds.sahabatechinvoice.fields.cabang') }}</th>
                            <th>{{ trans('cruds.sahabatechinvoice.fields.alamat') }}</th>
                            <th>{{ trans('cruds.sahabatechinvoice.fields.product') }}</th>
                            <th>{{ trans('cruds.sahabatechinvoice.fields.total_price') }}</th>
                            <th>{{ trans('cruds.sahabatechinvoice.fields.tax') }}</th>
                            <th>{{ trans('cruds.sahabatechinvoice.fields.start') }}</th>
                            <th>{{ trans('cruds.sahabatechinvoice.fields.status_bayar') }}</th>
                            <th>{{ trans('cruds.sahabatechinvoice.fields.bukti_pembayaran') }}</th>
                            {{-- <th>{{ trans('cruds.sahabatechinvoice.fields.status_sewa') }}</th> --}}
                            <th>&nbsp;</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        @foreach ($invoices as $invoice)
                            <tr data-entry-id="{{ $invoice->id }}">
                                ...
                                <td>
                                    ...
                                    {{ str_pad($monthNumber, 2, '0', STR_PAD_LEFT) }}-{{ $monthInRoman }}-SAHABATECH-{{ str_pad($invoice->id, 4, '0', STR_PAD_LEFT) }}
                                </td>
                                ...
                                <td>
                                    ...
                                    @can('sahabatechinvoice_delete')
                                        <form action="{{ route('admin.invoices.destroy', $invoice->id) }}" method="POST" class="delete-form" style="display: inline-block;">
