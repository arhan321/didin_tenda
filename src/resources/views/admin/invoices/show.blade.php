                ...
                <table class="table table-bordered table-striped">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{ $invoice->client->nama_client ?? 'Unknown' }}
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                {{ $invoice->client->alamat_client ?? 'Unknown' }}
                            </td>
                        </tr>
                        <tr>
                            <th>
                        ...
                        <tr>
                            ...
                            <td>
                                {{ 'Rp ' . number_format($invoice->price ?? 0, 2, ',', '.') }}
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                {{ $invoice->start ? \Carbon\Carbon::parse($invoice->start)->format('d M Y') : '' }}
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                ...
                                @elseif ($invoice->bukti_pembayaran)
                                    <h5 style="margin-bottom: 10px;">Bukti Pembayaran:</h5>
                                    <iframe src="{{ Storage::url($invoice->bukti_pembayaran) }}" width="100%" height="600px"></iframe>
...
@include('admin.invoices.invoice')
