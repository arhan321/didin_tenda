...
@section('content')
    @can('deliveryorder_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.deliveryorderbarang.create') }}">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover datatable datatable-DeliveryOrder">
                    ...
                    <tbody>
                        ...
                        @foreach ($deliveryorderbarangs as $deliveryOrder)
                            <tr data-entry-id="{{ $deliveryOrder->id }}">
                                ...
                                <td>
                                    @can('deliveryorder_show')
                                        <a class="btn btn-xs btn-primary" href="{{ route('admin.deliveryorderbarang.show', $deliveryOrder->id) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan

                                    @can('deliveryorder_edit')
                                        <a class="btn btn-xs btn-info" href="{{ route('admin.deliveryorderbarang.edit', $deliveryOrder->id) }}">
                                            {{ trans('global.edit') }}
                                        </a>
                                    @endcan

                                    @can('deliveryorder_delete')
                                        <form action="{{ route('admin.deliveryorderbarang.destroy', $deliveryOrder->id) }}" method="POST" class="delete-form" style="display: inline-block;">
        ...
        $(function() {
            ...
            @can('deliveryorder_delete')
                ...
                let deleteButton = {
                    ...
                    url: "{{ route('admin.deliveryorderbarang.massDestroy') }}",
