        ...
        <div class="modal-body" id="invoiceContent">
          ...
          <div style="font-family: Arial, sans-serif; font-size: 14px; padding: 20px;">
              ...
              <div style="text-align: right; margin-top: 130px;">
                ...
                <table style="width: 100%; border-collapse: collapse; margin-top: 10px;">
                  ...
                  <tr>
                    ...
                    <td style="padding: 5px; ">
                      {{ $deliveryorderbarang->id }}-{{ \Carbon\Carbon::parse($deliveryorderbarang->created_at)->format('m') }}-SJ-TAP-{{ \Carbon\Carbon::parse($deliveryorderbarang->created_at)->format('Y') }}
                    </td>
                </tr>
                </table>
              </div>
            ...
            <div style="margin-top: 20px;">
              ...
              <p style="padding-left: 10px; margin-top: 5px;">
                  <strong>{{ $deliveryorderbarang->client->nama_client ?? 'Unknown' }}</strong><br>
                  {{ $deliveryorderbarang->client->alamat_client ?? 'Alamat tidak tersedia' }}
              </p>
          </div>
          ...
          {{-- <div class="tulisan"
              ...
              <p>SURAT JALAN PERIODE
                  @php
                      $formattedDate = \Carbon\Carbon::parse($deliveryorderbarang->start)->format(' F Y');
            ...
            <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
              ...
              <tbody>
                  @php
                      $productDetails = isset($deliveryorderbarang->product_details)
            ...
            <div style="margin-top: 40px; display: flex; justify-content: space-between;">
              ...
              <div style="text-align: left;">
                  ...
                  <p style="margin: 0; margin-top:35%;">__________________________</p>
                  <p style="margin: 0; margin-top:5%;">Pengirim, {{ $deliveryorderbarang->pengantar ?? 'Unknown' }}</p>
              </div>
          </div>
...
<script>
  ...
  const deliveryOrderData = {
            id: {{ $deliveryorderbarang->id }},
            createdAt: "{{ $deliveryorderbarang->created_at }}"
        };
