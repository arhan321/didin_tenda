    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            <div class="col-lg-6" data-aos="fade-right">
                ...
                <h1 class="hero-title">
                    Sewakan Tenda & Dekorasi <span class="text-primary">Impian</span> untuk Acara Istimewa Anda
                </h1>
                <p class="hero-description">
                    Booking online 24/7, cek ketersediaan real-time, dan pembayaran aman via berbagai metode. 
                    Wujudkan acara impian bersama Didin Tenda Decoration.
                </p>
        ...
        <div class="quick-check-card" data-aos="zoom-in">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <a href="{{ route('frontend.index') }}#paket" class="btn btn-primary btn-lg w-100">Cek Ketersediaan</a>
                </div>
            </div>
...
<section id="paket" class="paket-section">
    <div class="container">
        ...
        <div class="text-center mt-5" data-aos="fade-up">
            <a href="{{ route('frontend.index') }}#paket" class="btn btn-primary btn-lg">Lihat Semua Paket</a>
        </div>
    </div>
</section>
...
<section id="galeri" class="galeri-section">
    <div class="container">
        ...
        <div class="text-center mt-5" data-aos="fade-up">
            <a href="{{ route('frontend.index') }}#galeri" class="btn btn-outline-primary btn-lg">Lihat Galeri Lengkap</a>
        </div>
    </div>
</section>
<!-- GALERI SECTION END -->
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                <div class="testimoni-card">
                    ...
                    <p class="testimoni-text">
                        "Pelayanan sangat memuaskan! Proses booking cepat dan mudah melalui website. 
                        Dekorasi sesuai pesanan dan tepat waktu. Terima kasih Didin Tenda!"
                    </p>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="testimoni-card">
                    ...
                    <p class="testimoni-text">
                        "Sangat merekomendasikan! Sistem pembayarannya aman dan transparan. 
                        Saya bisa cek ketersediaan tanggal sendiri tanpa perlu tanya-tanya dulu."
                    </p>
                    <div class="testimoni-user">
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                <div class="testimoni-card">
                    ...
                    <p class="testimoni-text">
                        "Tim profesional, peralatan berkualitas. Mulai dari tenda, kursi, sampai lampu semua lengkap. 
                ...
                <div class="accordion" id="accordionFAQ">
                    ...
                    <div class="accordion-item" data-aos="fade-up">
                        ...
                        <div id="faq1" class="accordion-collapse collapse show" data-bs-parent="#accordionFAQ">
                            <div class="accordion-body">
                                Anda bisa cek ketersediaan langsung di website kami melalui fitur "Cek Ketersediaan" 
                                dengan memilih tanggal acara dan paket yang diinginkan. Hasil akan ditampilkan secara real-time.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#accordionFAQ">
                            <div class="accordion-body">
                                Untuk mengamankan jadwal dan menghindari risiko gagal bayar, kami menerapkan sistem pembayaran 
                                lunas 100% di awal melalui payment gateway yang aman.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#accordionFAQ">
                            <div class="accordion-body">
                                Kami menerima berbagai metode pembayaran digital melalui Midtrans: transfer bank 
                                BCA, Mandiri, BRI, BNI, e-wallet GoPay, OVO, DANA, ShopeePay, dan QRIS.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <div id="faq4" class="accordion-collapse collapse" data-bs-parent="#accordionFAQ">
                            <div class="accordion-body">
                                Setelah pembayaran lunas berhasil, sistem akan mengirimkan konfirmasi booking secara otomatis 
                                dalam hitungan detik ke email dan WhatsApp Anda.
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-6 mb-4 mb-md-0">
                ...
                <ul class="footer-links">
                    <li><a href="{{ route('frontend.index') }}#beranda">Beranda</a></li>
        ...
        <div class="modal-content">
            ...
            <div class="modal-header border-0 pb-0">
                <div class="modal-tabs w-100">
                    ...
                    <button class="modal-tab-btn" data-tab="register">Daftar</button>
                </div>
            ...
            <div class="modal-footer border-0 pt-0 pb-4">
                <div class="social-login w-100">
                    ...
                    <div class="d-flex gap-2 justify-content-center">
                        <button class="btn btn-outline-secondary social-btn" type="button">
