    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.order-addons.store') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('addon_id') ? 'is-invalid' : '' }}" name="addon_id" id="addon_id">
                    ...
                    @foreach($addons as $addon)
                        <option
                            ...
                            {{ old('addon_id') == $addon->id ? 'selected' : '' }}
                        >
                ...
                @endif
                <span class="help-block">Pilih addon untuk mengisi data otomatis.</span>
            </div>
            ...
            <div class="form-group">
                ...
                @endif
                <span class="help-block">Total akan otomatis dihitung dari quantity x price.</span>
            </div>
