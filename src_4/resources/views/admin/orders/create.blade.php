    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.orders.store') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('invoice_number') ? 'is-invalid' : '' }}" type="text" name="invoice_number" id="invoice_number" value="{{ old('invoice_number', '') }}" placeholder="Kosongkan untuk otomatis">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('order_type') ? 'is-invalid' : '' }}" name="order_type" id="order_type" required>
                    @foreach($orderTypes as $key => $label)
                        <option value="{{ $key }}" {{ old('order_type', 'package') === $key ? 'selected' : '' }}>
                            {{ $label }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('event_date') ? 'is-invalid' : '' }}" type="date" name="event_date" id="event_date" value="{{ old('event_date', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('event_location_name') ? 'is-invalid' : '' }}" type="text" name="event_location_name" id="event_location_name" value="{{ old('event_location_name', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('event_address') ? 'is-invalid' : '' }}" name="event_address" id="event_address" rows="3">{{ old('event_address', '') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('event_latitude') ? 'is-invalid' : '' }}" type="text" name="event_latitude" id="event_latitude" value="{{ old('event_latitude', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('event_longitude') ? 'is-invalid' : '' }}" type="text" name="event_longitude" id="event_longitude" value="{{ old('event_longitude', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('distance_km') ? 'is-invalid' : '' }}" type="number" step="0.01" name="distance_km" id="distance_km" value="{{ old('distance_km', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('shipping_fee') ? 'is-invalid' : '' }}" type="number" name="shipping_fee" id="shipping_fee" value="{{ old('shipping_fee', 0) }}" min="0">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subtotal_package') ? 'is-invalid' : '' }}" type="number" name="subtotal_package" id="subtotal_package" value="{{ old('subtotal_package', 0) }}" min="0">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subtotal_custom') ? 'is-invalid' : '' }}" type="number" name="subtotal_custom" id="subtotal_custom" value="{{ old('subtotal_custom', 0) }}" min="0">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subtotal_addons') ? 'is-invalid' : '' }}" type="number" name="subtotal_addons" id="subtotal_addons" value="{{ old('subtotal_addons', 0) }}" min="0">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status" required>
                    @foreach($statusOptions as $key => $label)
                        <option value="{{ $key }}" {{ old('status', 'waiting_payment') === $key ? 'selected' : '' }}>
                            {{ $label }}
                        </option>
                    @endforeach
                </select>
            ...
            @foreach($datetimeFields as $field => $label)
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has($field) ? 'is-invalid' : '' }}" type="datetime-local" name="{{ $field }}" id="{{ $field }}" value="{{ old($field, '') }}">
                    @if($errors->has($field))
                        <div class="invalid-feedback">
                            {{ $errors->first($field) }}
                        </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('cancelled_reason') ? 'is-invalid' : '' }}" name="cancelled_reason" id="cancelled_reason" rows="3">{{ old('cancelled_reason', '') }}</textarea>
