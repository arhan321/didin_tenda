...
<html lang="id">
    ...
    <body>
        ...
        <div class="invoice-wrapper">
                ...
                <table class="header-table">
                    <tr>
                        <td style="width: 55%">
                            ...
                            <div class="brand-sub">
                                Jl. Ki Mas Laeng Kp. Katomas, Tigaraksa,
                                <br />
                                Kab. Tangerang, Banten
                                <br />
                                Telp/WA: 0882-8925-8764
                                <br />
                        ...
                        <td style="width: 50%; vertical-align: top">
                            ...
                            <table class="info-table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        :
                                        {{ $order->payment_deadline ? $order->payment_deadline->format('d/m/Y H:i') : '-' }}
                                    </td>
                                </tr>
                            </table>
                        </td>
            ...
            <div class="section">
                ...
                <table class="info-table">
                    ...
                    <tr>
                        ...
                        <td>
                            :
                            {{ $order->distance_km ? number_format((float) $order->distance_km, 1, ',', '.') . ' km' : '-' }}
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div class="footer">
                Invoice ini dibuat otomatis oleh sistem Didin Tenda Decoration.
                <br />
