        ...
        <section class="pesanan-section">
            <div class="container">
                ...
                <div class="demo-alert">
                    ...
                    <div>
                        <strong>Data Pesanan Real</strong>
                        <br />
                        <small>
                            Pesanan ditampilkan dari database sesuai akun yang sedang login. Pembayaran menggunakan
                            Midtrans Snap dan review bisa diberikan setelah pesanan selesai.
                        </small>
                    </div>
                </div>
