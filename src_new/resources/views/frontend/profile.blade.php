            ...
            <a class="navbar-brand" href="{{ route('frontend.index') }}">
                ...
                <div class="navbar-collapse collapse" id="navbarNav">
                    ...
                    <div class="navbar-user-menu d-flex align-items-center ms-lg-3">
                        ...
                        @else
                            <a href="{{ route('frontend.index') }}" class="btn btn-outline-light btn-sm">Login</a>
                        @endauth
                    </div>
                </div>
            </div>
                        ...
                        <div class="profile-sidebar">
                            ...
                            <div class="profile-menu">
                                ...
                                <a
                                    ...
                                    onclick="showNotification('🔧 Pengaturan akun akan segera hadir!', 'info')"
                                >
...
{{ old('alamat', $user->alamat) }}</textarea
                            ...
                            <div class="change-password-section mt-5 pt-3">
                                ...
                                <form
                                    ...
                                    method="POST"
                                    action="{{ route('frontend.profile.updatePassword') }}"
                                >
                                    @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="payment-methods">
                            ...
                            />
                            <img
                                src="https://placehold.co/60x40/2c3e50/white?text=OVO"
                                alt="OVO"
                                class="payment-logo"
                            />
                        </div>
