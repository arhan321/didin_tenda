    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <div class="navbar-user-menu d-flex align-items-center ms-lg-3">
                ...
                @guest
                    <div class="d-flex">
                        <a href="#" class="btn btn-outline-light me-2 btn-sm" data-auth-tab="login" data-bs-toggle="modal" data-bs-target="#loginRegisterModal">Login</a>
                        <a href="#" class="btn btn-primary btn-sm" data-auth-tab="register" data-bs-toggle="modal" data-bs-target="#loginRegisterModal">Daftar</a>
                    </div>
                @endguest
            ...
            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="500">
                <div class="paket-card">
                    ...
                    <div class="paket-content">
                        ...
                        <p class="paket-desc">
                            Sesuaikan dekorasi dengan kebutuhan acara Anda
                        </p>
...
<div class="modal fade" id="loginRegisterModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body p-4 pt-3 {{ $authModalTab === 'register' ? 'd-none' : '' }}" id="loginForm">
                ...
                <form id="formLogin" method="POST" action="{{ route('frontend.login') }}">
                    ...
                    <div class="text-center text-muted">
                        <small>
                            Belum punya akun?
                            <a href="#" class="switch-to-register" data-tab="register">
                                Daftar di sini
                            </a>
                        </small>
                    </div>
            ...
            <div class="modal-body p-4 pt-3 {{ $authModalTab === 'register' ? '' : 'd-none' }}" id="registerForm">
                ...
                <form id="formRegister" method="POST" action="{{ route('frontend.register') }}">
                    ...
                    <div class="text-center text-muted">
                        <small>
                            Sudah punya akun?
                            <a href="#" class="switch-to-login" data-tab="login">
                                Login di sini
                            </a>
                        </small>
                    </div>
